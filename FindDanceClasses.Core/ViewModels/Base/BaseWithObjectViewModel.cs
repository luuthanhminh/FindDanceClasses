...
{
    public abstract class BaseWithObjectViewModel<TObject> : MvxNavigationViewModel<TObject>
    {
        protected readonly IDialogService DialogService;

        #region Constructors

        public BaseWithObjectViewModel(IMvxNavigationService navigationService, IDialogService dialogService, IMvxLogProvider logProvider) : base(logProvider, navigationService)
        {
