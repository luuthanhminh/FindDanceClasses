...
namespace FindDanceClasses.Core.ViewModels
{
    ...
    public class EventSetupViewModel : BaseViewModel
    {
        ...
        public EventSetupViewModel(IMvxNavigationService navigationService, IDialogService dialogService, IMvxLogProvider logProvider,
